...
use crate::vendor::bumpalo::alloc::{handle_alloc_error, Alloc, Layout, UnstableLayoutMethods};
...
impl<'a, T> RawVec<'a, T> {
    ...
    pub unsafe fn into_box(self) -> crate::vendor::bumpalo::boxed::Box<'a, [T]> {
...
impl<'a, T> RawVec<'a, T> {
    ...
    fn reserve_internal(
        ...
        unsafe {
            use crate::vendor::bumpalo::AllocErr;
