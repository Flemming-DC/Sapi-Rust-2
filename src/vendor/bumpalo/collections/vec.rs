...
use crate::vendor::bumpalo::collections::CollectionAllocErr;
...
// #[macro_export]
#[allow(unused_macros)] macro_rules! vec_bump {
...
impl<'bump, T> Vec<'bump, T> {
    ...
    /// ```
    pub fn into_boxed_slice(mut self) -> crate::vendor::bumpalo::boxed::Box<'bump, [T]> {
        use crate::vendor::bumpalo::boxed::Box;
...
// #[cfg(feature = "boxed")]
impl<'bump, T: 'bump> From<Vec<'bump, T>> for crate::vendor::bumpalo::boxed::Box<'bump, [T]> {
    fn from(v: Vec<'bump, T>) -> crate::vendor::bumpalo::boxed::Box<'bump, [T]> {
        v.into_boxed_slice()
    }
}
